...
def parse_config_into_btc_config():
    ...
    # FirstIslamicCoin: this was hardcoded to "Bitcoin Core" -- the only one
    # of the PACKAGE_* strings this generator actually substitutes (the
    # others are plain literals in bitcoin_config.h.in, fixed there
    # directly), so it alone needed fixing at the source rather than in the
    # template.
    config_dict["PACKAGE_STRING"] = f"\"FirstIslamicCoin Core {version}\""
