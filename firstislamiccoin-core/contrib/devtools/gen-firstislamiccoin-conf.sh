...
BITCOIND=${BITCOIND:-$BINDIR/firstislamiccoind}
SHARE_EXAMPLES_DIR=${SHARE_EXAMPLES_DIR:-$TOPDIR/share/examples}
EXAMPLE_CONF_FILE=${EXAMPLE_CONF_FILE:-$SHARE_EXAMPLES_DIR/firstislamiccoin.conf}
...
then
  ...
  echo -e "To safely generate a firstislamiccoin.conf file, please commit your changes to $BITCOIND, rebuild, then run this script again.\n"
fi

echo 'Generating example firstislamiccoin.conf file in share/examples/'
...
# parse the output from firstislamiccoind --help
