...
def main():
    ...
    # Filter out hosts with multiple codexacoin ports, these are likely abusive
    ips = filtermultiport(ips)
    print(f'{ip_stats(ips):s} Filter out hosts with multiple codexacoin ports', file=sys.stderr)
