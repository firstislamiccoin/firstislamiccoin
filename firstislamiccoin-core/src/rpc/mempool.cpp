...
static void entryToJSON(const CTxMemPool& pool, UniValue& info, const CTxMemPoolEntry& e) EXCLUSIVE_LOCKS_REQUIRED(pool.cs)
{
    ...
    // FirstIslamicCoin: no bip125-replaceable field -- RBF opt-in signaling
    // (IsRBFOptIn/RBFTransactionState) was removed from this fork along with
    // the rest of RBF support, and this field's RPCResult declaration above
    // was removed to match (it used to be pushed here unconditionally).
