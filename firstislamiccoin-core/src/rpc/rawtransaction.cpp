                     ...
                     TxVerbosity verbosity = TxVerbosity::SHOW_DETAILS)
{
    ...
    // available to code in firstislamiccoin-common, so we query them here and push the
    ...
    return
         {
             ...
             {RPCResult::Type::STR, "address", /*optional=*/true, "The FirstIslamicCoin address (only if a well-defined address exists)"},
...
static std::vector<RPCResult> DecodeTxDoc(const std::string& txid_field_doc)
{
    return {
        ...
        {RPCResult::Type::NUM_TIME, "time", /*optional=*/true, "The transaction time (only present for version 1 transactions)"},
...
static RPCHelpMan decodepsbt()
{
    return RPCHelpMan{
        "decodepsbt",
        "Return a JSON object representing the serialized, base64-encoded partially signed FirstIslamicCoin transaction.",
                {
...
static RPCHelpMan combinepsbt()
{
    return RPCHelpMan{"combinepsbt",
                "\nCombine multiple partially signed FirstIslamicCoin transactions into one transaction.\n"
