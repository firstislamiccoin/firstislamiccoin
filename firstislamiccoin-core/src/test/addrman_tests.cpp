...
BOOST_AUTO_TEST_CASE(addrman_simple)
{
    ...
    vAddr.emplace_back(ResolveService("250.1.1.3", 15714), NODE_NONE);
    vAddr.emplace_back(ResolveService("250.1.1.4", 15714), NODE_NONE);
...
BOOST_AUTO_TEST_CASE(addrman_select_special)
{
    ...
    // add ipv4 address to the new table
    CService addr1 = ResolveService("250.1.1.3", 15714);
    BOOST_CHECK(addrman->Add({CAddress(addr1, NODE_NONE)}, source));
...
BOOST_AUTO_TEST_CASE(load_addrman)
{
    ...
    addr1 = Lookup("250.7.1.1", 15714, false);
    ...
    const std::optional<CService> source{Lookup("252.5.1.1", 15714, false)};
