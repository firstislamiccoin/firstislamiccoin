...
BOOST_AUTO_TEST_CASE(packet_test_vectors) {
    ...
    //
    // FirstIslamicCoin: the salt is "bitcoin_v2_shared_secret" + MessageStart(), so the
    // published BIP324 vectors (Bitcoin magic f9beb4d9) cannot match this chain's magic
    // (f11c51a3). Inputs are unchanged. The magic-dependent outputs (garbage terminators,
    // session id, ciphertext) were recomputed with a pure-Python BIP324 implementation that
    // first reproduced every upstream vector byte for byte with the Bitcoin magic.
    ...
    TestBIP324PacketVector(
        ...
        "",
        false,
        "18ee32777fbb909bca129b5291625d68",
        "41ce96cc1384069c9105a3a2ee5b3f1a",
        "a1a248b2378af0b195694c6d3d683efed1cb3096d89a4d836ba7e32c1d9c16f0",
        "9f4ee0968cd8d5922ae776e3c5a367ad93f5bebd8f",
        "");
    TestBIP324PacketVector(
        999,
        ...
        "",
        false,
        "a3a66fdb7915c3193c390964141dd171",
        "610dab12a6ac2f0d57f26c0163547cb0",
        "c0a2e7639c31d26827ccf4f94983ce47f2aadbb4077dc4b9d869054eae677699",
        "221682f4c476177f1fd1d962a8cd3a3222587b0c67a97132e746c693e51ece723ca759a879",
        "");
    TestBIP324PacketVector(
        0,
        ...
        false,
        "a5befb9abade6a471d754ebd981fbdaa",
        "9c1ba54b19080ca1b247aef5a8b79798",
        "c3afa4f5d78f52a6968a6e6edfc5a27bc79baaa16b9b8e8b71d5b05e21e0292a",
        "2bd5f5f35e64bafbe79c2747c7a8f3c949e04925720c29664fef11dba2494ceb009c9b8d21bcfe9e8f274e6b99fde6c7036d29eddef6b1a805f80de152dddeab1d4d52e52150825a37abd52bc666d51f312a7a",
        "");
    TestBIP324PacketVector(
        223,
        ...
        "",
        true,
        "3cae70a3bb3daf3c4b4d7721c7088fc6",
        "75641b142e85a98ee7b26adc67f479f3",
        "8dc333c8f7302eef282fd4f7929ceae12be02fac5cccab16e8181fc763b53d1f",
        "",
        "");
    TestBIP324PacketVector(
        448,
        ...
        "",
        false,
        "91d1b431899c522fb82e645f8b73ad3b",
        "97ed7680c016ad62eeee237e00700c44",
        "ea5fbea40077ce84de13764533f1c91165e5355078edb06b6229e35a8b3686a1",
        "",
        "");
    TestBIP324PacketVector(
        673,
        ...
        "",
        false,
        "5002d2c725518f12e20ea3c8aa70db86",
        "502dd02cec86b48ca5803ae110ffc3f4",
        "484dcdfa2b00d86fa6dcce26b85a3b4e8db3e625b8f9104ac006dd2c81ae7ec2",
        "",
        "");
    TestBIP324PacketVector(
        1024,
        ...
        "",
        true,
        "518d579311f34aa6404cf705db087f83",
        "53b40ce54c560a7b76bd064c8d62b482",
        "cba13c642c7d3807b38097bff6d99bdbd1736e2167d9e42497159d3eaa64d876",
        "",
        "");
}
