...
static const std::string strSecret1 = "6VwKHGq4H1syQ5jpgkejGeFi7qQ18MTycgSdM83ZTMVgHBU5xHb";
static const std::string strSecret2 = "6XAs161NREMDsnCL1uU4pkbazUiTUg6BmNXnoB3Eo5WBicD19aL";
static const std::string strSecret1C = "RGijgps7Tgsyvsv1UTfXa3RvVAcXZTL4tV67Rp6JFKTaNPpVrzK3";
static const std::string strSecret2C = "RNAXhP6dXwvFq8UzvzaTsmRf2hKys9XtWr2u8oJstNspJT7Fq7AV";
static const std::string addr1 = "FtRZHGCadaF2UzKMBft3mifjRtcQkYB77g";
static const std::string addr2 = "FjFgX8ocv6m6SEL14Fgp2zSNhRVuqVMYDh";
static const std::string addr1C = "Fry2JicFWsrs6oK2BdSXk6RdWghBnkHarg";
static const std::string addr2C = "FgbSUChiZhD4RtBeDWtBirn1LXj77aKCbe";

static const std::string strAddressBad = "FmernWnEvnFWPL5gdCeeVegZRM8wQB39yP";
