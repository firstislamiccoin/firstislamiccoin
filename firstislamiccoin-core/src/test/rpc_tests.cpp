...
BOOST_AUTO_TEST_CASE(rpc_rawparams)
{
    ...
    std::string rawtx = "";
    BOOST_CHECK_NO_THROW(r = CallRPC(std::string("decoderawtransaction ")+rawtx));
    BOOST_CHECK_EQUAL(r.get_obj().find_value("size").getInt<int>(), 197);
...
BOOST_AUTO_TEST_CASE(rpc_rawsign)
{
    ...
    std::string privkey1 = "\"RKkEZQnY3451Ti8QRjXdcgoe6wwNCykfyFEYqHhVkwDUe5HicCdf\"";
    std::string privkey2 = "\"RJaLEtKHczQu9K7k4hoJr98189xyUNph8rb1tNip239usBU9fucH\"";
...
BOOST_AUTO_TEST_CASE(help_example)
{
    ...
    BOOST_CHECK_EQUAL(HelpExampleCliNamed("test", args), "> firstislamiccoin-cli -named test foo=bar b=true n=1\n");
    ...
    // test shell escape
    BOOST_CHECK_EQUAL(HelpExampleCliNamed("test", {{"foo", "b'ar"}}), "> firstislamiccoin-cli -named test foo='b'''ar'\n");
    BOOST_CHECK_EQUAL(HelpExampleCliNamed("test", {{"foo", "b\"ar"}}), "> firstislamiccoin-cli -named test foo='b\"ar'\n");
    BOOST_CHECK_EQUAL(HelpExampleCliNamed("test", {{"foo", "b ar"}}), "> firstislamiccoin-cli -named test foo='b ar'\n");
    ...
    BOOST_CHECK_EQUAL(HelpExampleCliNamed("test", {{"name", obj_value}}), "> firstislamiccoin-cli -named test name='{\"foo\":\"bar\",\"b\":false,\"n\":1}'\n");
    ...
    BOOST_CHECK_EQUAL(HelpExampleCliNamed("test", {{"name", arr_value}}), "> firstislamiccoin-cli -named test name='[\"bar\",false,1]'\n");
