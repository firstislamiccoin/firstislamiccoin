...
static std::map<std::string, unsigned int> mapFlagNames = {
    ...
    {std::string("DERKEY"), (unsigned int)SCRIPT_VERIFY_DERKEY}, // FirstIslamicCoin (Blackcoin lineage), part of MANDATORY_SCRIPT_VERIFY_FLAGS
};
...
BOOST_AUTO_TEST_CASE(basic_transaction_tests)
{
    ...
    // FirstIslamicCoin: converted to the FIC format (nVersion 1 is followed by a 4-byte nTime, here 0)
    unsigned char ch[] = {};
...
BOOST_AUTO_TEST_CASE(test_IsStandard)
{
    ...
    // FirstIslamicCoin: witness outputs are only standard when IsStandardTx() is called with
    // witnessEnabled=true (policy/policy.cpp, validation.cpp passes the deployment state).
    constexpr auto CheckIsStandardWitness = [](const auto& t) {
        std::string reason;
        BOOST_CHECK(IsStandardTx(CTransaction{t}, MAX_OP_RETURN_RELAY, g_bare_multi, g_dust, reason, /*witnessEnabled=*/true));
        BOOST_CHECK(reason.empty());
    };
    constexpr auto CheckIsNotStandardWitness = [](const auto& t, const std::string& reason_in) {
        std::string reason;
        BOOST_CHECK(!IsStandardTx(CTransaction{t}, MAX_OP_RETURN_RELAY, g_bare_multi, g_dust, reason, /*witnessEnabled=*/true));
        BOOST_CHECK_EQUAL(reason_in, reason);
    };
    ...
    // FirstIslamicCoin: DUST_RELAY_TX_FEE is 100000 sat/kvB (Bitcoin Core: 3000 -> 546)
    ...
    // FirstIslamicCoin: MAX_OP_RETURN_RELAY is 223 (Bitcoin Core: 83): OP_RETURN OP_PUSHDATA1 <len> <220 bytes>
    BOOST_CHECK_EQUAL(MAX_OP_RETURN_RELAY, 223U);
    t.vout[0].scriptPubKey = CScript() << OP_RETURN << std::vector<unsigned char>(MAX_OP_RETURN_RELAY - 3, 0x04);
    BOOST_CHECK_EQUAL(MAX_OP_RETURN_RELAY, t.vout[0].scriptPubKey.size());
    CheckIsStandard(t);

    // MAX_OP_RETURN_RELAY+1-byte TxoutType::NULL_DATA (non-standard)
    t.vout[0].scriptPubKey = CScript() << OP_RETURN << std::vector<unsigned char>(MAX_OP_RETURN_RELAY - 2, 0x04);
    ...
    t.vout[0].nValue = 19200;
    CheckIsStandard(t);
    t.vout[0].nValue = 19199;
    CheckIsNotStandard(t, "dust");
    ...
    t.vout[0].nValue = 22400;
    CheckIsStandard(t);
    t.vout[0].nValue = 22399;
    CheckIsNotStandard(t, "dust");
    ...
    t.vout[0].nValue = 18200;
    CheckIsStandard(t);
    t.vout[0].nValue = 18199;
    CheckIsNotStandard(t, "dust");

    // Check P2SH outputs dust threshold
    t.vout[0].scriptPubKey = CScript() << OP_HASH160 << std::vector<unsigned char>(20, 0) << OP_EQUAL;
    t.vout[0].nValue = 18000;
    CheckIsStandard(t);
    t.vout[0].nValue = 17999;
    CheckIsNotStandard(t, "dust");

    // Check P2WPKH outputs dust threshold
    t.vout[0].scriptPubKey = CScript() << OP_0 << std::vector<unsigned char>(20, 0);
    CheckIsNotStandard(t, "scriptpubkey"); // witness outputs need witnessEnabled
    t.vout[0].nValue = 9800;
    CheckIsStandardWitness(t);
    t.vout[0].nValue = 9799;
    CheckIsNotStandardWitness(t, "dust");

    // Check P2WSH outputs dust threshold
    t.vout[0].scriptPubKey = CScript() << OP_0 << std::vector<unsigned char>(32, 0);
    CheckIsNotStandard(t, "scriptpubkey");
    t.vout[0].nValue = 11000;
    CheckIsStandardWitness(t);
    t.vout[0].nValue = 10999;
    CheckIsNotStandardWitness(t, "dust");
    ...
    for (int op = OP_1; op <= OP_16; op += 1) {
        ...
        CheckIsNotStandard(t, "scriptpubkey");
        t.vout[0].nValue = 8000;
        CheckIsStandardWitness(t);

        t.vout[0].nValue = 7999;
        CheckIsNotStandardWitness(t, "dust");
    }
}
