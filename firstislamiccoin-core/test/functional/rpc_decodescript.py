...
class DecodeScriptTest(BitcoinTestFramework):
    ...
    def decoderawtransaction_asm_sighashtype(self):
        ...
        # FirstIslamicCoin: version 1 transactions serialize a 4-byte nTime after nVersion, so a zero
        # nTime is inserted into these Bitcoin mainnet transactions (this also changes their txid).
        # this test case uses a mainnet transaction that has a P2SH input and both P2PKH and P2SH outputs.
        tx = ''
        ...
        tx = ''
        rpc_result = self.nodes[0].decoderawtransaction(tx)
        assert_equal('60a0db0e04818769729a711cf30101489605126a81ca9fcd0fa6122a4e0cb71b', rpc_result['txid'])
        ...
        tx = ''
        rpc_result = self.nodes[0].decoderawtransaction(tx)
        assert_equal('OP_RETURN 300602010002010001', rpc_result['vout'][0]['scriptPubKey']['asm'])

        self.log.info("- tx passing DER signature checks")
        # verify that we have not altered scriptPubKey processing even of a specially crafted P2PKH pubkeyhash and P2SH redeem script hash that is made to pass the der signature checks
        tx = ''
        rpc_result = self.nodes[0].decoderawtransaction(tx)
    ...
    def decodescript_miniscript(self):
        ...
        assert res["segwit"]["desc"] == "addr(rfic1q73qyfypp47hvgnkjqnav0j3k2lq3v76wg22dk8tmwuz5sfgv66xskrpx88)#esehtyud"
