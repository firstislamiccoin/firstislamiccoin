...
class ReorgsRestoreTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        outputs_1[self.nodes[0].getnewaddress()] = Decimal("9.999")  # FirstIslamicCoin: fee must meet GetMinFee
        outputs_2[self.nodes[0].getnewaddress()] = Decimal("9.999")  # FirstIslamicCoin: fee must meet GetMinFee
